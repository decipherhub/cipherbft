...
use cipherbft_rpc::{
    RpcConfig, RpcServer, StubDebugExecutionApi, StubExecutionApi, StubMempoolApi, StubNetworkApi, StubRpcStorage,
};
...
async fn start_test_server() -> (
    String,
    Arc<RpcServer<StubRpcStorage, StubMempoolApi, StubExecutionApi, StubNetworkApi, StubDebugExecutionApi>>,
) {
    ...
    let server = Arc::new(RpcServer::new(config, storage, mempool, executor, network, debug_executor));
