    ...
    Ctx: Context,
{
    ...
    /// Counter for consecutive sync blocked iterations.
    /// Used to detect when sync is stuck and needs a forced reset.
    pub consecutive_blocked_count: u32,
}
    ...
    Ctx: Context,
{
    ...
    /// Clear all pending requests. Used when sync is stuck.
    pub fn clear_all_pending_requests(&mut self) {
        self.pending_value_requests.clear();
        self.height_per_request_id.clear();
        self.consecutive_blocked_count = 0;
    }
