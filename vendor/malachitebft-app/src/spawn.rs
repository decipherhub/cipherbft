    ...
    Ctx: Context,
{
    ...
    let sync_config = sync::Config {
        ...
        // Tip-first sync: start syncing from near network tip for faster startup
        // These fields use defaults as ValueSyncConfig doesn't expose them yet
        tip_first_sync: false,
        tip_first_buffer: 100,
    };
